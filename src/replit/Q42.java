...
SDET Motors Inc. is recalling all vehicles 
from model years 1995-1998,
  2001-2002,  2004-2006 and 2015-2017. 

In this assignment you will write a program 
that will find vehicle for recall. 
...
input: 1996
 ...
 if the value of modelYear does fall within 
 the four recall ranges, display output:
